...
You can use the official `@zorveus/sdk` TypeScript client, the `zorveus` Python library, or any standard OpenAI SDK pointing to `https://api.zorveus.com/v1`.

<CodeGroup titles={["TypeScript (@zorveus/sdk)", "Python (zorveus)", "Python (ZorveusOpenAI)", "cURL", "Python (OpenAI SDK)", "TypeScript (OpenAI SDK)", "JavaScript (Node.js)", "Go"]}>
