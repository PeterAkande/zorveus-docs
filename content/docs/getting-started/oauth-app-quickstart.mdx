...
<Steps>
  <Step title="Generate Code Verifier and Code Challenge">
    ...
    <CodeGroup titles={["TypeScript (@zorveus/sdk)", "Python (zorveus)", "Browser / Node.js (Web Crypto)", "Python (hashlib)"]}>

    ```typescript
    import { ZorveusOAuth } from "@zorveus/sdk";

    // Generate PKCE code verifier, S256 challenge, and CSRF state token
    ...
    # Generate PKCE code verifier, S256 challenge, and state token
    ...
    ```typescript
    // Generate PKCE code verifier and S256 code challenge manually
...
<CodeGroup titles={["TypeScript (@zorveus/sdk)", "Python (zorveus)", "Node.js (TypeScript)", "Python (Requests)", "cURL"]}>
...
const tokenResponse = await ZorveusOAuth.exchangeToken({
  clientId: "zrv_client_your_client_id",
  clientSecret: "zrv_client_secret_your_client_secret",
  code: code,
